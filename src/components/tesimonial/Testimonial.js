  ...
  return (
    ...
    >
      <div className="flex justify-center items-center text-center">
        <Title title="WHAT CLIENTS SAY" des="Comments" />
      </div>
            ...
            <div className="w-full h-auto flex flex-col lgl:flex-row justify-between">
              <div className="w-full lgl:w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b] p-8 rounded-lg shadow-shadowOne flex flex-col md:flex-row lgl:flex-col gap-8 justify-center md:justify-start lgl:justify-center">
                ...
                <div className="w-full flex flex-col justify-end">
                  ...
                  <h3 className="text-2xl font-bold">John Dike</h3>
              ...
              <div className="w-full lgl:w-[60%] h-full flex flex-col justify-between">
                ...
                <div className="w-full h-[70%] py-10 bg-gradient-to-r from-[#1e2024] to-[#23272b] rounded-lg shadow-shadowOne p-4 lgl:p-8 flex flex-col justify-center gap-4 lgl:gap-8">
                  <div className="flex flex-col justify-between lgl:items-center py-6 border-b-2 border-b-gray-900">
                    <div className="w-full lgl:w-auto flex flex-col lgl:items-center">
                  ...
                  <p className="text-base font-titleFont text-gray-400 font-medium tracking-wide leading-6">
                    Good job, it is the attention to detail and creativity in
                    crafting user interfaces significantly enhanced the overall
            ...
            <div className="w-full h-auto flex flex-col lgl:flex-row justify-between">
              <div className="w-full lgl:w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b] p-8 rounded-lg shadow-shadowOne flex flex-col md:flex-row lgl:flex-col gap-8 justify-center md:justify-start lgl:justify-center">
                ...
                <div className="w-full flex flex-col justify-end">
                  ...
                  <h3 className="text-2xl font-bold">Emmanuel Musa</h3>
                  <p className="text-base tracking-wide text-gray-500">
                    Backend Developer
                  </p>
                </div>
            ...
            <div className="w-full h-auto flex flex-col lgl:flex-row justify-between">
              <div className="w-full lgl:w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b] p-8 rounded-lg shadow-shadowOne flex flex-col md:flex-row lgl:flex-col gap-8 justify-center md:justify-start lgl:justify-center">
                ...
                <div className="w-full flex flex-col justify-end">
                  ...
                  <h3 className="text-2xl font-bold">Fawaz Momoh</h3>
                  <p className="text-base tracking-wide text-gray-500">
                    UI/UX Designer
                  </p>
                </div>
                ...
                <div className="w-full h-[70%] py-10 bg-gradient-to-r from-[#1e2024] to-[#23272b] rounded-lg shadow-shadowOne p-4 lgl:p-8 flex flex-col justify-center gap-4 lgl:gap-8">
                  <div className="flex flex-col justify-between lgl:items-center py-6 border-b-2 border-b-gray-900">
                    <div className="w-full lgl:w-auto flex flex-col lgl:items-center">
                      ...
                      <p className="text-base text-gray-400 mt-3">
                        via Upwork - Mar 4, 2022 - Aug 30, 2022
                      </p>
                    </div>
                    <div className="text-yellow-500 flex gap-1">
                      <RiStarFill />
